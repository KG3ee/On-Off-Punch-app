...
type PublicUserWithTeam = Prisma.UserGetPayload<{ select: typeof PUBLIC_USER_WITH_TEAM_SELECT }>;
...
export class UsersService {
  ...
  async updateUser(id: string, dto: UpdateUserDto): Promise<PublicUserWithTeam> {
  ...
  async updatePassword(id: string, password: string, mustChangePassword = false): Promise<void> {
